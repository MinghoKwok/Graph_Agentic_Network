...
def run_node_classification(
    ...
    jsonl_path = os.path.join("..", "data", dataset_name, dataset_config["text_graph_file"])
...
if __name__ == "__main__":
    ...
    if args.dataset not in config.SUPPORTED_DATASETS:
        print(f"Error: Unsupported dataset '{args.dataset}'. Supported datasets: {', '.join(config.SUPPORTED_DATASETS)}")
        sys.exit(1)
