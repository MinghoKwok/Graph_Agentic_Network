...
label_vocab_module = importlib.import_module(f"data.{dataset_name}.label_vocab")
label_vocab = label_vocab_module.label_vocab
legacy_label_mapping = getattr(label_vocab_module, "legacy_label_mapping", None)


def load_cora(
    jsonl_path: str = os.path.join("../data/cora", "cora_text_graph_simplified.jsonl"),
    edge_path: str = os.path.join("../data/cora", "cora.cites")
) -> Dict[str, Any]:
    """
...
def load_citeseer(
    jsonl_path: str = os.path.join("../data/citeseer", "citeseer_text_graph_simplified.jsonl"),
    edge_path: str = os.path.join("../data/citeseer", "citeseer.cites")
) -> Dict[str, Any]:
    """
    Load citeseer dataset using simplified JSONL + true citation edges.
    ...
    Returns:
        ...
        - num_nodes: Total number of nodes
    """
    print(f"🔄 Loading citeseer dataset from {jsonl_path} and {edge_path}")
...
def load_arxiv(
    jsonl_path: str = os.path.join("../data/arxiv", "arxiv_text_graph_simplified.jsonl"),
    edge_path: str = os.path.join("../data/arxiv", "arxiv.cites")
) -> Dict[str, Any]:
    """
    Load arxiv dataset using simplified JSONL + true citation edges.    
    ...
    Returns:
        ...
        - num_nodes: Total number of nodes
    """
    print(f"🔄 Loading arxiv dataset from {jsonl_path} and {edge_path}")    
